...
from vag_cnn.pytorch_autoencoder import CNNAutoencoderSpectrograms
from vag_cnn.pytorch_data_loader import SpectrogramDataset
...
# --------------------------
def main():
    dataset = SpectrogramDataset("images/EMD_CWT/")
